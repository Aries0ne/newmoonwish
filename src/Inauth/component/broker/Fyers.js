...
import { fyersBroker } from '../../../redux/actions/brokerAction';
const Fyers = () => {
        ...
        <>
            <div className="border">
                <Box>
                    <Grid xs={12} lg={12}>
                        {/* <Box >
                            <Typography style={{ display: 'flex', justifyContent: 'center', marginTop: '10px' }} component={'label'} className='label'>FYERS BROKER</Typography>
