...
export default function Strategys(props) {
  ...
  const col = ["Sr.No", "Symbol", "Date", "Time", "Trend Status", "Time Frame", "Data", "Final Value", "HH/LL", "PMH", "CMH", "PWH", "PWL", "CDH", "CDL", "HH"];
  // Dropdwon
      ...
      <Box className="border-ap">
        <Box className="tabs">
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Box className="selectiondiv-box" sx={{ marginBottom: 2, display: 'flex !important' }}>
                <Dropdown
                  title={title}
                  val={drpValue}
                  value={exchange}
